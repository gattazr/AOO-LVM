...
public class MachineLISP {
	...
	public MachineLISP() {
		...
		this.pContext.addToContextGeneral(new Symbol("eprogn"), new Eprogn());
		this.pContext.addToContextGeneral(new Symbol("eq"), new Eq());
		this.pContext.addToContextGeneral(new Symbol("eval"), new Eval());
		this.pContext.addToContextGeneral(new Symbol("explode"), new Explode());
		this.pContext.addToContextGeneral(new Symbol("implode"), new Implode());
